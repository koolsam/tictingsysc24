...
$hook_array['before_save'][] = Array(3, 'Add security group', 'custom/modules/Cases/hooks/CaseGroupAddHook.php','CaseGroupAddHook', 'caseAddGroup'); 
...
$hook_array['after_save'][] = Array(3, 'Case Creation Email', 'custom/modules/Cases/hooks/CaseCommunicationHook.php','CaseCommunicationHook', 'caseCreationGroupEmail');
